...
MAKECMD         = /Applications/MATLAB_R2012b.app/bin/maci64/gmake
HOST            = UNIX
BUILD           = yes
...
MODEL                = opitcal_flow
MODULES              = HostLib_rtw.c opitcal_flow_data.c opticalflow_hs_c_rt.c rtGetInf.c rtGetNaN.c rt_logging.c rt_nonfinite.c simaqcodegen.c sobelderivative_hs_r_rt.c 
MAKEFILE             = opitcal_flow.mk
MATLAB_ROOT          = /Applications/MATLAB_R2012b.app
ALT_MATLAB_ROOT      = /Applications/MATLAB_R2012b.app
MATLAB_BIN           = /Applications/MATLAB_R2012b.app/bin
MASTER_ANCHOR_DIR    = 
START_DIR            = /Users/dagoodma/Dropbox/School/cmpe264/project
S_FUNCTIONS          = 
S_FUNCTIONS_LIB      = 
SOLVER               = 
NUMST                = 2
...
ADD_INCLUDES = \
	...
	-I$(MATLAB_ROOT)/toolbox/imaq/imaqblks/include \
	-I$(MATLAB_ROOT)/toolbox/shared/dsp/vision/matlab/include \
	-I$(START_DIR)/opitcal_flow_grt_rtw \
	-I$(START_DIR) \
...
%.o : $(MATLAB_ROOT)/toolbox/imaq/imaqblks/include/%.c
	@$(GCC_TEST_CMD) "$<" $(GCC_TEST_OUT)
	$(CC) -c $(CFLAGS) $(GCC_WALL_FLAG_MAX) "$<"

%.o : $(MATLAB_ROOT)/toolbox/vision/extern/vipopticalflow/%.c
	@$(GCC_TEST_CMD) "$<" $(GCC_TEST_OUT)
	$(CC) -c $(CFLAGS) $(GCC_WALL_FLAG_MAX) "$<"
...
%.o : $(MATLAB_ROOT)/toolbox/shared/dspblks/extern/src/%.cpp
	@$(GCC_TEST_CMD) "$<" $(GCC_TEST_OUT)
	$(CPP) -c $(CPPFLAGS) "$<"
%.o : $(MATLAB_ROOT)/toolbox/imaq/imaqblks/include/%.cpp
	@$(GCC_TEST_CMD) "$<" $(GCC_TEST_OUT)
	$(CPP) -c $(CPPFLAGS) "$<"
%.o : $(MATLAB_ROOT)/toolbox/vision/extern/vipopticalflow/%.cpp
	@$(GCC_TEST_CMD) "$<" $(GCC_TEST_OUT)
	$(CPP) -c $(CPPFLAGS) "$<"
